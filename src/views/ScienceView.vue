<template>
  <div class="science-page">
    ...
    <div class="page-header">
      <h1>科学中心</h1>
      <p>每一支CORONG产品背后，都是对东南亚气候的深度研究</p>
    </div>
    ...
    <section class="ingredients-section">
      <h2>核心成分解析</h2>
      <p class="section-sub">我们只选用经过科学验证的原料</p>
      ...
      <div class="story-content">
        <div class="story-text">
          ...
          <div class="story-stats">
            <div class="s-stat">
              <strong>2000+</strong><span>肤色数据样本</span>
            </div>
            <div class="s-stat">
              <strong>3年</strong><span>实地研发周期</span>
            </div>
            <div class="s-stat">
              <strong>3城市</strong><span>泰国实测地点</span>
            </div>
          </div>
        </div>
...
const ingredients = [
  {
    icon: '🌸',
    name: '兰纳莲花提取物',
    origin: '产自泰国清迈，海拔1200米高地',
    desc: '兰纳地区特有的高山莲花，富含天然多糖和黄酮类物质，具有极强的锁水保湿能力。在东南亚高温高湿环境下能形成透气防护膜，阻止皮脂过度分泌。',
    benefits: ['12小时控油', '补水保湿', '抗氧化', '舒缓敏感'],
    efficacy: 92,
  },
  {
    icon: '🔷',
    name: '微孔硅石复合体',
    origin: '实验室合成，专利配方',
    desc: '纳米级多孔硅石颗粒，能吸附相当自身重量数倍的油脂，同时保持粉体的轻盈感。这是CORONG持妆技术的核心——在吸油的同时不产生干燥感。',
    benefits: ['超强吸油', '轻薄感', '不致痘', '透气性强'],
    efficacy: 88,
  },
  {
    icon: '🌿',
    name: '姜黄素衍生物',
    origin: '泰国传统草本，现代提纯工艺',
    desc: '源自泰国传统医学的姜黄，经过现代提纯去除了染色成分，保留了强效的抗炎和抗氧化活性。能有效对抗紫外线造成的氧化损伤，延缓肌肤老化。',
    benefits: ['抗氧化', '抗炎', '均匀肤色', '抗UV损伤'],
    efficacy: 85,
  },
  {
    icon: '💧',
    name: '热带海洋胶原肽',
    origin: '泰国湾深海鱼类提取',
    desc: '低分子量胶原肽，分子量约300Da，可渗透角质层补充真皮胶原蛋白。与高温气候下加速流失的胶原形成互补，长期使用改善肌肤弹性。',
    benefits: ['补充胶原', '紧致肌肤', '改善弹性', '长效保湿'],
    efficacy: 80,
  },
]
...
const techList = [
  {
    icon: '🛡️',
    title: '热稳定成膜技术',
    desc: '独特的聚合物网络在38°C高温下依然保持结构稳定，不融化、不位移，是持妆的核心技术壁垒。',
    stat: '38°C',
    statLabel: '热稳定上限',
    color: 'linear-gradient(135deg, #ff6b6b, #ffa07a)',
  },
  {
    icon: '💧',
    title: '湿度自适应控油',
    desc: '成膜剂能感知环境湿度变化，湿度越高控油效果越强，在泰国雨季表现尤为突出。',
    stat: '90%',
    statLabel: '湿度耐受上限',
  ...
  },
  {
    icon: '☀️',
    title: 'UV光稳定防护',
    desc: '内置有机UV吸收剂与无机钛白粉双重防护，在UV指数高达11的极端条件下也能有效保护肌肤。',
    stat: 'UV 11',
    statLabel: '最高防护指数',
  ...
  },
  {
    icon: '🌈',
    title: '东南亚肤色适配',
    desc: '针对象牙白到深邃棕6大肤色类型独立调色，确保每种肤色都能找到完美匹配，不出现灰暗或不自然感。',
    stat: '6',
    statLabel: '专属色号系列',
    color: 'linear-gradient(135deg, #d94a87, #ff8cc8)',
  },
]
...
.bar-fill-star {
  height: 100%;
  background: linear-gradient(90deg, #d94a87, #ff8cc8);
  border-radius: 3px;
...
.r-item.highlight {
  background: rgba(217,74,135,0.2);
